...
let scoreOrdinateur = document.getElementById("scoreORDI");
let btnJoueur = [...document.getElementsByClassName("btn-joueur")];
let opierreBtn = document.getElementById("pierre1");
let ofeuilleBtn = document.getElementById("feuille1");
let ociseauxBtn = document.getElementById("ciseaux1");
